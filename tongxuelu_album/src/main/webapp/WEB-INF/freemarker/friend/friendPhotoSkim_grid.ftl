...
<head>
    ...
    <link rel="stylesheet" href="/index/css/fluid-gallery.css">
    <style>
...
<div class="htmleaf-container">
    <div class="container gallery-container">
        ...
        <div class="jq22-demo">
            ...
            <a href="${pageContext.request.contextPath}/PhotoController/allPhoto/${pageInfo.list[0].albumId}/1">流式幻灯展示</a>
            <a href="${pageContext.request.contextPath}/PhotoController/allPhoto_grid/${pageInfo.list[0].albumId}/1">Grid组合欣赏</a>

        </div>
        <p class="page-description text-center">see me life,gogogo</p>
            ...
            <ul class="pagination">
                ...
                <#--<li>
                    <c:if test="${pageInfo.hasPreviousPage}">
                        <a href="${pageContext.request.contextPath}/PhotoController/allPhoto/${pageInfo.list[0].albumId}?pn=${pageInfo.pageNum-1}" aria-label="Previous">
