...
public class FtpConfig {
	...
	/*public FtpConfig()	{
			this.setFTP_ADDRESS("192.168.73.187");
			this.setFTP_BASEPATH("/home/ftpuser/www/images");
			this.setFTP_PASSWORD("123456");
			this.setFTP_PORT("21");
			this.setFTP_USERNAME("ftpuser");
			this.setIMAGE_BASE_URL("http://192.168.73.187/images");
